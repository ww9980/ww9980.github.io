  ...
  function go() {
    typish('#typer')
      ...
      .type('今天严允帮你在线做作业呀', '<span class="note">')
      .type('0', '<br>')
      .type('00', '<span class="blank">')
      .wait(10)
      .type('等下哦。。。', '<span class="note">') 
      .wait(10)
      ...
      .type(':', '<span class="blue">')
      .type('0', '<span class="blank">')
      .type("'ww9980'", '<span class="green">')
      .wait(15)
      .del(6)
      .type("'严允'", '<span class="green">')
      .type(',', '<span class="gray">')
      .type('0', '<br>')
      // 珊珊
      .type('0000', '<span class="blank">')
  ...
  function count() {
    const date = new Date('2018/01/16 00:00:00')
    let end = new Date()
